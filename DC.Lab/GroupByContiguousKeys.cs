...
public class GroupByContiguousKeys
{
    // The source sequence
...
public static class ChunkExtensions
{
        ...
        )
    {
        ...
        while (true)
        {
            ...
            // Make a new Chunk (group) object that initially has one GroupItem, which is a
            // copy of the current source element.
            ...
            // ChunkBy method. At this point, the Chunk only has the first element in its source sequence.
            // The remaining elements will be returned only when the client code foreach's over this chunk.
            ...
            // foreach loop to iterate the chunk items, and the loop ran to completion,
...
class Chunk<TKey, TSource> : IGrouping<TKey, TSource>
{
    ...
    // Each Chunk has a reference to the next ChunkItem in the list.
    class ChunkItem
    {
    ...
    private void CopyNextChunkElement()
    {
        ...
        // If we are (a) at the end of source, or (b) at the end of the current chunk
        ...
        while (true)
        {
            lock (m_Lock)
            {
                if (DoneCopyingChunk)
                {
                    ...
                    // it signals to the source iterator
    ...
    // the client requests the last element in the list so far.
