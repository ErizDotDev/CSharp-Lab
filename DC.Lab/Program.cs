...
// A special EventArgs class to hold info about shapes
...
// Represents the shape on which the shapes are drawn
...
public class ShapeContainer
{
    ...
    public void AddShape(Shape shape)
    {
        ...
        // Subscribe to the base class evemt.
...
class Test
{
    static void Main()
    {
        // Create the event publisher and subscribers
